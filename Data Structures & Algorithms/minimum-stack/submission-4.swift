class MinStack {
    // the internal stack, arranged such that each Element is a tuple tracking:
    //  - the last known value
    //  - the last known min
    // this approach allows the data structure to have O(1) lookup of the stack's global min
